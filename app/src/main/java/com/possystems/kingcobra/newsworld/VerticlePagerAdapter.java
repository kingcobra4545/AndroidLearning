...
public class VerticlePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = mLayoutInflater.inflate(R.layout.card_view, container, false);

        TextView txtTitle = (TextView) itemView.findViewById(R.id.titleTxt);
        TextView txtDesc = (TextView) itemView.findViewById(R.id.descriptionTxt);
        TextView txtSourceAndTime = (TextView) itemView.findViewById(R.id.news_source_and_time);
        ...
        txtSourceAndTime.setText(dataModel.getPublishedAT());
